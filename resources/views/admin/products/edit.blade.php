        ...
        <div class="container-fluid">
            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="short_description" id="short_description" cols="30" rows="10"
                                            class="summernote" placeholder="">{{ $product->short_description }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="sku">SKU (Đơn vị lưu giữ hàng tồn kho)</label>
                ...
                <div class="col-md-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="sub_category" id="sub_category" class="form-control">
                                    <option value="">Chọn một danh mục phụ</option>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <h2 class="h4 mb-3">Sản phẩm tiêu biểu</h2>
                            <div class="mb-3">
            ...
            <div class="pb-5 pt-3">
                ...
                <a href="{{ route('products.index') }}" class="btn btn-outline-dark ml-3">Huỷ bỏ</a>
            </div>
        </div>
    </form>
    <!-- /.card -->
           ...
           var html = `<div class="col-md-3" id="image-row-${response.image_id}"><div class="card">
            <input type="hidden" name="image_array[]" value="${response.image_id}">
                ...
                <div class="card-body">
                    ...
                    <a href="javascript:void(0)" onclick="deleteImage(${response.image_id})" class="btn btn-danger">Xoá</a>
                </div>
            </div>  </div>`;
